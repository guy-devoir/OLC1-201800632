...
public class Interface extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            pars.parse();
            int errores = pars.tokens.size();
            this.jLabel2.setText("Errores Sintacticos: " + errores);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        String path2 = "C:\\Users\\Luciano Xiquín\\Desktop\\[OLC]Manual_tecnico.pdf";
...
String path2 = "C:\\Users\\Luciano Xiquín\\Desktop\\[OLC]Manual_Usuario.pdf";
    File file = new File(path2);
    try {
      if (file.exists()) {
        Process pro = Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + path);
